...
<script type="text/javascript" src="{{ asset('/backend/assets/js/pages/layout_fixed_custom.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('/backend/assets/js/pages/form_inputs.js')}}"></script>
...
<script type="text/javascript" src="{{ asset('/backend/assets/js/plugins/ui/fab.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('/backend/assets/js/plugins/ui/prism.min.js')}}"></script>
...
<script type="text/javascript" src="{{ asset('/backend/assets/js/plugins/pickers/pickadate/picker.js')}}"></script>
<script type="text/javascript" src="{{ asset('/backend/assets/js/plugins/pickers/pickadate/picker.date.js')}}"></script>
<script type="text/javascript" src="{{ asset('/backend/assets/js/plugins/pickers/pickadate/picker.time.js')}}"></script>
<script type="text/javascript" src="{{ asset('/backend/assets/js/plugins/pickers/pickadate/legacy.js')}}"></script>
<script type="text/javascript" src="{{ asset('/backend/assets/js/core/libraries/jquery_ui/interactions.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('/backend/assets/js/plugins/forms/styling/switchery.min.js')}}"></script>
...
<script type="text/javascript" src="{{ asset('/backend/assets/js/plugins/ui/fullcalendar/lang/ar.js')}}"></script>
<script type="text/javascript" src="{{ asset('/backend/assets/js/plugins/forms/inputs/duallistbox.min.js')}}"></script>
