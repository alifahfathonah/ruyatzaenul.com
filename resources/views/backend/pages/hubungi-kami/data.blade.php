<form class="form-horizontal">
  <fieldset class="content-group">
    <div class="form-group">
      <label class="control-label col-lg-4"><h2>Hubungi Kami</h2></label>
      <div class="col-lg-12">
          @if (count($data)!=0)
            <div class="row">
              <div class="form-group">
        ...
        @else
          <center>
            ...
            <br>
            <button class="btn btn-primary btn-sm" type="button" onclick="bukaform(-1)"><i class="icon-diff-added"></i>&nbsp;&nbsp;Tambah Data Contact</button>
          </center>
          @php
            $id=-1;
            $lat=$long=0;
    ...
    <div class="form-group">
      <div class="text-right">
        <button type="button" onclick="bukaform({{$id}})" class="btn btn-success"><i class="icon-pencil5"></i>&nbsp;&nbsp;Edit</button>
      </div>
    </div>
    @endif
  </fieldset>
...
function siteccit()
{
  ...
  if(latt!='0')
  {
    ...
    var contentString = '<div id="content">'+
      '<div id="siteNotice">'+
      '</div>'+
      '<h1 id="firstHeading" class="firstHeading" style="text-align:center">CEP CCIT Fakultas Teknik UI</h1>'+
