...
@section('title')
	<title>Event | CEP-CCIT FTUI Admin Pages</title>
@stop
...
@section('footscripts')
  ...
  function loadData(id)
  {
    ...
    $('div#data').load(APP_URL+'/event-data/'+id,function(){
  		...
  		$(".switch").bootstrapSwitch();
			$('.switch').on('switchChange.bootstrapSwitch', function (event, state) {
				...
				$.ajax({
						dataType: 'json',
						type:'POST',
						url: APP_URL+'/event-status/'+iduser,
						data:{flag : st},
						...
						// getPageData();
						var txt = "Status Event Berhasil Di Edit";
  ...
  function hapus(id)
  {
  	...
  	$('#hapusbutton').click(function(){
          ...
          $('#modal-hapus').modal('hide');
  				    new PNotify({
  		            title: 'Berhasil',
  		            text: 'Data Event Berhasil Di Hapus',
  		            addclass: 'alert bg-success alert-styled-right',
  		            type: 'success'
  		        });
  						loadData(-1);
  ...
  <ul class="fab-menu fab-menu-fixed fab-menu-bottom-right" data-fab-toggle="hover">
      <li>
        ...
        <ul class="fab-menu-inner">
  				<li>
  					<div data-fab-label="Tambah event">
  						<a href="{{URL::to('/event-form/-1')}}" class="btn btn-default btn-rounded btn-icon btn-float">
