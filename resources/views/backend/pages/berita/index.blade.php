...
@section('title')
	<title>Publikasi | Official Website Ru'yat-Zaenul</title>
@stop
...
function loadData(id)
{
  ...
  $('div#data').load(APP_URL+'/berita-data/'+id,function(){
    ...
    $('table#data-berita').DataTable({
		...
		$('.switch').on('switchChange.bootstrapSwitch', function (event, state) {
			...
			$.ajax({
					dataType: 'json',
					type:'POST',
					url: APP_URL+'/berita-status/'+iduser,
					data:{flag : st},
					...
					// getPageData();
					var txt = "Status Berita Berhasil Di Edit";
