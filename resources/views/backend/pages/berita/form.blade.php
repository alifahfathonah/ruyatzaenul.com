...
@section('title')
	<title>Form Publikasi | Official Website Ru'yat-Zaenul</title>
@stop
	...
	<div class="page-header">
		...
		<div class="breadcrumb-line breadcrumb-line-component">
			<ul class="breadcrumb">
				...
				<li class=""><a href="{{URL::to('/berita')}}">Publikasi</a></li>
				<li class="active">Form Publikasi</li>
			</ul>
		</div>
	</div>
@stop
              ...
              <form class="form-horizontal" action="{{$id==-1 ? URL::to('berita') : URL::to('berita/'.$id) }}" method="POST" id="form-berita">
                <fieldset class="content-group">
                  ...
                  <div class="form-group">
                    <label class="control-label col-lg-2">Judul Publikasi</label>
                    <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-6">
                      <select class="select2" name="id_kategori" data-placeholder="-Pilih-">
                          <option value=""></option>
                          @foreach ($cat as $k => $v)
                            @if ($id!=-1)
